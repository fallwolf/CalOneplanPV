...
def caldata(file):
  # 调试时显示当前计算的文件
  #print(file)
  workbook = xlrd.open_workbook(filepath+file)
...
traverse_directory(filepath, extension)
